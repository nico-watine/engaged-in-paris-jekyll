...
<section class="bgvid-container">
	...
	<video autoplay loop preload="auto" poster="http://cdn.nicowatine.me/wegotengagedinparis/img/proposal-story/video/splash/poster.jpg" class="bgvid" id="is-desktop">
	...
	<div class="section-photos">
		<div class="row photo-row double-photo">
			<div class="photo-wrapper" id="first">
				<img src="http://cdn.nicowatine.me/wegotengagedinparis/img/proposal-story/lock-bridge/lock-bridge-selfie.jpg" alt="Nico &amp; Corinne Selfie on the Lock Bridge">
			</div>
			<div class="photo-wrapper" id="second">
				<img src="http://cdn.nicowatine.me/wegotengagedinparis/img/proposal-story/lock-bridge/corinne-posing.jpg" alt="Corinne Posing For A Photo On The Lock Bridge">
			</div>
		</div>
		<div class="row photo-row single-photo">
			<img src="http://cdn.nicowatine.me/wegotengagedinparis/img/proposal-story/lock-bridge/lock-bridge-view.jpg" alt="Side View Of The Lock Bridge">
		</div>
	</div>
</section>
...
<section id="notre-dame" class="proposal-opportunity">
	...
	<div class="section-photos">
		<div class="row photo-row single-photo">
			<figure>
				<img src="http://cdn.nicowatine.me/wegotengagedinparis/img/proposal-story/notre-dame/notre-dame-facade.jpg" alt="Front Facade of Notre Dame">
...
<script src="http://cdn.nicowatine.me/wegotengagedinparis<?php autoVer('/js/scripts-min.js'); ?>"></script>
<script>
